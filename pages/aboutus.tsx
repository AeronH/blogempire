  ...
  return (
    <main className='scroll-smooth'>
      ...
      <section className='max-w-7xl mx-auto space-y-10 my-10'>
        ...
        <div className='py-[75px] px-[60px] flex bg-[url(https://images.pexels.com/photos/2678468/pexels-photo-2678468.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)] bg-no-repeat bg-cover bg-center h-fit'>
